...
inputs = {
  test_tools_a = "${dependency.datastore.outputs.datastore_a_output}"
  test_tools_b = "${dependency.datastore.outputs.datastore_b_output}"
  test_tools_c = "test_tools_c_output"
}
